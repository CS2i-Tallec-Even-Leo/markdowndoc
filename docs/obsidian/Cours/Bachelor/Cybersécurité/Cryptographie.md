...
## Chiffrement Irréversible *(ex : Fonction de Hash peut importe la taille du fichier l'empreinte fais la même taille)* ^20214f
...
- Et avec du Sel alors ?
		- en base de donnés on se retrouve avec le sel la fonction cryptographique en clair et le mot de passe HASHÉ 
		- le sel est ajouter avant de balancer le mdp dans la fonction cryptographique 
		- en sortie de fonction on retrouve un message à la forme \$fonction\$SEL\$MOTDEPASSEHASHÉ
...
- Authentification et Intégrité
	...
	-  HMIC {Hashed-base Message Integration Code} :
		![[Pasted image 20240919121056.png]]
	
	- Signature numérique :![[Pasted image 20240919121302.png]]
